  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        <li><i class="fa fa-phone"></i> 8512463587</li>
        <li><i class="fa fa-envelope-o"></i> Aumgujarati@gmail.com</li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
    ...
    <div class="one_third first">
      ...
      <ul class="nospace linklist contact">
        <li><i class="fa fa-map-marker"></i>
          ...
          <p>
          Name        : Mr Aum Gujarati <br>
          University  : Charusat<br>
          Batch       : 2k23 <br>
          Dept        : IT<br>
          </p>
          </address>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2017 - All Rights Reserved - <a href="#">Md. Aum Gujarati</a></p>
